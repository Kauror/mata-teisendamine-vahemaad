...
const MODES = [
  { id: 'loendamine', name: 'Loendamine', category: 'Loendamine', topic: 'loendamine', emoji: '🔢', accent: 'topic-emoji-counting' },
  { id: 'arvutamine-10', name: 'Arvutamine 10 piires', category: 'Arvutamine 10 piires', topic: 'arvutamine', emoji: '🍎', accent: 'topic-emoji-addition' },
  { id: 'arvutamine-20', name: 'Arvutamine 20 piires', category: 'Arvutamine 20 piires', topic: 'arvutamine', emoji: '🧩', accent: 'topic-emoji-twenty' },
  { id: 'suurem-vaiksem-100', name: 'Suurem või väiksem kui 100', category: 'Suurem või väiksem kuni 100', topic: 'arvutamine', emoji: '⚖️', accent: 'topic-emoji-compare' },
  { id: 'segaulesanded', name: 'Segaülesanded', category: 'Segaülesanded', topic: 'arvutamine', emoji: '🎲', accent: 'topic-emoji-mixed' }
] as const;
...
export default function KirsiMathPageClient({ activeModes }: { activeModes: string[] }) {
  ...
  return (
    <PracticeSetupPage
      ...
      subjectEmoji='🧮'
      topics={visibleModes.map((mode) => ({ id: mode.id, name: mode.name, emoji: mode.emoji, accent: mode.accent }))}
