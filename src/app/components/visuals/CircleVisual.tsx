import type { GeneratedQuestion, QuestionVisual } from '@/lib/types';

// Circle / geometry graphics shared between the exercise runner (/test) and the
// "Ring ja ringjoon" study page, so the child sees the exact same shapes in both
// places. Pure presentational SVG — no external assets, sharp at any size.
...
// Draw a named visual on its own. Kordamine replays a saved question from a
// snapshot rather than a GeneratedQuestion, so it needs this entry point; the
// runner keeps using ShapeVisual below.
export function NamedShapeVisual({ visual, knownDegrees }: { visual: QuestionVisual; knownDegrees?: number }) {
  if (visual === 'circle-full') return <svg width='140' height='140' aria-label='Täisring'><circle cx='70' cy='70' r='50' fill='#eef2ff' stroke='#3b82f6' strokeWidth='4' /></svg>;
  if (visual === 'circle-half') return <svg width='140' height='140' aria-label='Poolring'><path d='M20 70a50 50 0 0 1 100 0Z' fill='#bfdbfe' stroke='#3b82f6' strokeWidth='3' /><path d='M20 70a50 50 0 1 1 100 0' fill='none' stroke='#3b82f6' strokeWidth='4' /></svg>;
  if (visual === 'circle-quarter') return <svg width='140' height='140' aria-label='Veerandring'><path d='M70 70 L70 20 A50 50 0 0 1 120 70 Z' fill='#bfdbfe' stroke='#3b82f6' strokeWidth='3' /><circle cx='70' cy='70' r='50' fill='none' stroke='#3b82f6' strokeWidth='4' /></svg>;
  if (visual === 'ring-outline') return <svg width='140' height='140' aria-label='Ringjoon'><circle cx='70' cy='70' r='52' fill='none' stroke='#3b82f6' strokeWidth='6' /></svg>;
  if (visual === 'ring-filled') return <svg width='140' height='140' aria-label='Ring'><circle cx='70' cy='70' r='52' fill='#bfdbfe' stroke='#3b82f6' strokeWidth='4' /></svg>;
  if (visual === 'radius-demo') return <svg width='160' height='140' aria-label='Raadiuse näide'><circle cx='70' cy='70' r='50' fill='none' stroke='#3b82f6' strokeWidth='3' /><circle cx='70' cy='70' r='4' fill='#0f172a' /><line x1='70' y1='70' x2='120' y2='70' stroke='#16a34a' strokeWidth='4' /><line x1='70' y1='70' x2='100' y2='40' stroke='#ef4444' strokeWidth='3' /><line x1='30' y1='90' x2='95' y2='95' stroke='#f59e0b' strokeWidth='3' /><text x='123' y='74' fontSize='14'>A</text><text x='102' y='38' fontSize='14'>B</text><text x='97' y='100' fontSize='14'>C</text><text x='58' y='64' fontSize='14'>O</text></svg>;
  if (visual === 'diameter-demo') return <svg width='160' height='140' aria-label='Läbimõõdu näide'><circle cx='70' cy='70' r='50' fill='none' stroke='#3b82f6' strokeWidth='3' /><circle cx='70' cy='70' r='4' fill='#0f172a' /><line x1='20' y1='70' x2='120' y2='70' stroke='#16a34a' strokeWidth='4' /><line x1='70' y1='70' x2='105' y2='40' stroke='#ef4444' strokeWidth='3' /><line x1='30' y1='95' x2='95' y2='98' stroke='#f59e0b' strokeWidth='3' /><text x='122' y='74' fontSize='14'>B</text><text x='107' y='39' fontSize='14'>A</text><text x='97' y='104' fontSize='14'>C</text><text x='58' y='64' fontSize='14'>O</text></svg>;
  if (visual === 'point-position') return <svg width='160' height='140' aria-label='Punkti asukoht'><circle cx='70' cy='70' r='50' fill='#eff6ff' stroke='#3b82f6' strokeWidth='3' /><circle cx='62' cy='58' r='4' fill='#16a34a' /><text x='68' y='56' fontSize='12'>A</text><circle cx='120' cy='70' r='4' fill='#f59e0b' /><text x='126' y='74' fontSize='12'>B</text><circle cx='135' cy='35' r='4' fill='#ef4444' /><text x='141' y='39' fontSize='12'>C</text></svg>;
  if (visual === 'concentric-circles') return <svg width='160' height='140' aria-label='Sama keskpunktiga ringjooned'><circle cx='70' cy='70' r='52' fill='none' stroke='#6366f1' strokeWidth='3' /><circle cx='70' cy='70' r='30' fill='none' stroke='#22c55e' strokeWidth='3' /><circle cx='70' cy='70' r='4' fill='#0f172a' /></svg>;
  if (visual === 'sector-missing') return <SectorMissingVisual knownDegrees={knownDegrees} />;
  if (visual === 'place-value-blocks') return <svg width='220' height='140' aria-label='Järguplokid'><rect x='10' y='20' width='34' height='34' fill='#bfdbfe' stroke='#3b82f6' /><rect x='50' y='20' width='24' height='24' fill='#c7f9cc' stroke='#16a34a' /><rect x='80' y='20' width='16' height='16' fill='#fde68a' stroke='#d97706' /><rect x='102' y='24' width='10' height='10' fill='#fecdd3' stroke='#e11d48' /><text x='10' y='70' fontSize='12'>Tuhandelised</text><text x='90' y='70' fontSize='12'>Sajalised</text><text x='10' y='88' fontSize='12'>Kümnelised</text><text x='90' y='88' fontSize='12'>Ühelised</text></svg>;
...
export function ShapeVisual({ question }: { question: GeneratedQuestion }) {
  if (question.visual) return <NamedShapeVisual visual={question.visual} knownDegrees={question.visualKnownDegrees} />;
